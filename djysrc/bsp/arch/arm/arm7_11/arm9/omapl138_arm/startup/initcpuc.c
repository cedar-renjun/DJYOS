...
{
    config_pll0(1,0,15,0,DIV_ENABLE|0,DIV_ENABLE|3,DIV_ENABLE|7);
...
#if 1
    DdriiReg->SDTIMR1 =   (((u32) ((cn_trfc_128M * cfg_ddrii_clk / 1000) )) << 25) |
                     (((u32) ((cn_trp_128M * cfg_ddrii_clk / 1000) )) << 22) |
                     (((u32) ((cn_trcd_128M * cfg_ddrii_clk / 1000) )) << 19) |
                     (((u32) ((cn_twr * cfg_ddrii_clk / 1000) )) << 16) |
                     (((u32) ((cn_tras * cfg_ddrii_clk / 1000) )) << 11) |
                     (((u32) ((cn_trc_128M * cfg_ddrii_clk / 1000) )) << 6)  |
                     (((u32) ((cn_trrd  * cfg_ddrii_clk / 1000))) << 3)  |  // tRRD = 10ns // Increase this if memory is still unstable - tlee
//                                   (2<<3) |
                     (DdriiReg->SDTIMR1 & 0x4)                                |  // Reserved
//                     (((u32) ((cn_twtr * cfg_ddrii_clk / 1000) ))  << 0);    // tWTR=7.5ns       
...
//Modified many by Tony here;    
     DdriiReg->SDTIMR2 = (DdriiReg->SDTIMR2 & 0x80000000) |  // Reserved
                     ...
                     (((u32) (((cn_trfc_128M+10) * cfg_ddrii_clk / 1000) )) << 16) |  // tXSNR=Trfc+10=138.5ns
                     ((cn_txsrd - 1)  << 8)   |  // tXSRD (200 Cycles)
                     (((u32) ((cn_trtp * cfg_ddrii_clk / 1000)))  << 5)   |  // tRTP (1 Cycle); 7.5ns
                     ((cn_tcke-1) << 0);     // tCKE
#else
    ...
    DdriiReg->SDRCR   = (0x1 << 31)  |  
                     ...
                     (0x0 << 23)  |  // SR_PD
                     (0x0 << 16)  |  // Reserved
                     (((u32) ((7.8 * cfg_ddrii_clk))) << 0);     // RR, 7.8us.
    DdriiReg->PBBPR = 0x20;
