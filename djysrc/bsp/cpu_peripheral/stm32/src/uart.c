...
ptu32_t module_init_uart1(ptu32_t para)
{
    ...
    temp1 = cfg_pclk2/(16*115200);
    temp2 = cfg_pclk2%(16*115200);
    temp2 = temp2/115200;
    ...
    u16g_evtt_uart1_error = djy_evtt_regist(enum_correlative,
                            cn_prio_real,0,0,5,uart_error_service,10,"uart1 err");
    ...
    u16g_evtt_uart1_hard_recv = djy_evtt_regist(enum_correlative,cn_prio_real,0,
                                   0,5,uart1_hard_recv_service,32,"uart1 recv");
    if(u16g_evtt_uart1_hard_recv == cn_invalid_evtt_id)
        goto exit_from_hard_recv_evtt;

    djy_event_pop(u16g_evtt_uart1_hard_recv,NULL,0,NULL,0,0,0);
...
uint32_t uart1_int(ufast_t uart_int_line)
{
    ...
    if(bb_uart1_sr_rxne == 1)
    {
        ...
        if(num != 1)
        {
            ...
            djy_event_pop(u16g_evtt_uart1_error,NULL,0,&parameter,
                   ...
                   uint32_t data1,uint32_t data2)
{
    ...
    switch(cmd)
    {
        ...
        case cn_uart_set_baud:  //设置Baud
            ...
            {
                temp1 = cfg_pclk2/(16*data1);
                temp2 = cfg_pclk2%(16*data1);
                temp2 = temp2/data1;
...
ptu32_t module_init_uart2(ptu32_t para)
{
    ...
    temp1 = cfg_pclk1/(16*115200);
    temp2 = cfg_pclk1%(16*115200);
    temp2 = temp2/115200;
                   ...
                   uint32_t data1,uint32_t data2)
{
    ...
    switch(cmd)
    {
        ...
        case cn_uart_set_baud:  //设置Baud
            ...
            {
                temp1 = cfg_pclk1/(16*data1);
                temp2 = cfg_pclk1%(16*data1);
                temp2 = temp2/data1;
