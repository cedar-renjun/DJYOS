...
void lcd_reset(void)
{
    gpio_setto_low(cn_gpio_g,0x100);
    djy_delay_10us(500);
    gpio_setto_high(cn_gpio_g,0x100);
}

void lcd_backlight_on(void)
{
    gpio_setto_low(cn_gpio_f,0x400);
}

void lcd_backlight_off(void)
{
    gpio_setto_high(cn_gpio_f,0x400);
}
...
void __lcd_ili9325_init(void)
{
    ...
    gpio_cfg_pin_func(cn_gpio_f,10,cn_gpio_mode_gpio_out_od_2Mhz);
    gpio_cfg_pin_func(cn_gpio_g,8,cn_gpio_mode_gpio_out_pp_2Mhz);
    lcd_backlight_off();
    lcd_reset();
