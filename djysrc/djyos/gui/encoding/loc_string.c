...
//-----------------------------------------------------------------------------
s32 djy_mblen(const char* mbs, u32 n)
{
    u32 wc;
...
//      其他:mbs缓冲区内第一个完整多字节字符的长度。
//-----------------------------------------------------------------------------
s32 djy_mblen_l(const char* mbs, u32 n, struct char_encoding_rsc* locale)
{
    u32 wc;
...
//      其他:mbs缓冲区内第一个完整多字节字符的长度。
//-----------------------------------------------------------------------------
s32 djy_mbtowc(u32* pwc, const char* mbs, u32 n)
{
    struct char_encoding_rsc* cur_enc;
...
//      其他:mbs缓冲区内第一个完整多字节字符的长度。
//-----------------------------------------------------------------------------
s32 djy_mbtowc_l(u32* pwc, const char* mbs, u32 n, struct char_encoding_rsc* locale)
{
...
//-----------------------------------------------------------------------------
s32 djy_mbstowcs(u32* pwcs, const char* mbs, u32 n)
{
    struct char_encoding_rsc* cur_enc;
...
//      其他:得到的字符数，=n表示源串是不包含串结束符'\0'。
//-----------------------------------------------------------------------------
s32 djy_mbstowcs_l(u32* pwcs, const char* mbs, u32 n, 
...
//      其他:转换结果的字符长度(字节数)
//-----------------------------------------------------------------------------
s32 djy_wctomb_l(char* mb, u32 wc,struct char_encoding_rsc* locale)
{
...
//-----------------------------------------------------------------------------
s32 djy_wcstombs(char* mbs, const u32* pwcs, u32 n)
{
    struct char_encoding_rsc* cur_enc;
...
//      其他:写入mbs缓冲区的字节数，含串结束符'\0'
//-----------------------------------------------------------------------------
s32 djy_wcstombs_l(char* mbs, const u32* pwcs, u32 n,
                struct char_encoding_rsc* locale)
{
    if((pwcs == NULL) || (locale == NULL))
        return 0;
