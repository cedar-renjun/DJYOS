...
s32 __gb2312_mb_to_ucs4 (u32 *pwc, const char *mbs, s32 n);
s32 __gb2312_mbs_to_ucs4s(u32* pwcs, const char* mbs, s32 n);
s32 __gb2312_ucs4_to_mb(char* s, u32 wc);
s32 __gb2312_ucs4s_to_mbs(char* mbs, const u32* pwcs, s32 n);
...
s32 __gb2312_ucs4_to_mb (char* mb, u32 wc)
{
    u16 used;
    u16 i, c;
...
ptu32_t module_init_encode_gb2312(ptu32_t para)
{
    ...
    encoding.max_len = 2;
    encoding.mb_to_ucs4 = __gb2312_mb_to_ucs4;
    encoding.ucs4_to_mb = __gb2312_ucs4_to_mb;
    encoding.mbs_to_ucs4s = __gb2312_mbs_to_ucs4s;
    encoding.ucs4s_to_mbs = __gb2312_ucs4s_to_mbs;
    if(nls_install_char_encoding(&encoding, cn_nls_charset_gb2312))
    {
