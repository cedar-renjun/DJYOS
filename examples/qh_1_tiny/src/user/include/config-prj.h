...
#define cfg_fine_us 0x0000038e  //1/72M,精密时钟脉冲长度，以uS为单位，32位定点数整数、小数各占16位，这也限制了ticks最长不超过65535uS
#define cfg_fine_hz cfg_mclk  //内核精密时钟频率，是cn_fine_ns的倒数。
...
#define cfg_time_src cfg_time_src_rtc  //选择走时基准
...
#define cfg_wdts_limit 1  //允许养狗数量
...
#define cfg_page_size 0x400  //基页尺寸为1Kbytes
#define cfg_page_size_suffix_zero 10  //页尺寸后缀0的个数
