...
#define cfg_mclk (36*M)  //主频
#define cfg_fclk cfg_mclk  //cm0自由运行外设时钟
#define cfg_ahbclk cfg_mclk  //总线时钟
#define cfg_tick_us 1000  //操作系统内核时钟脉冲长度，以微秒为单位。
#define cfg_tick_hz 1000  //内核时钟频率，单位为hz。
#define cfg_fine_us 0x0ccd  //50nS,精密时钟脉冲长度，以uS为单位，32位定点数，整数小数各占16位，这也限制了ticks最长不超过65535uS
