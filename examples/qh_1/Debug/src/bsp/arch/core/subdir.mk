...
src/bsp/arch/core/cpus.o: C:/djysdk/djysrc/bsp/arch/arm/cortex_m/cortex_m3/core/cpus.S
	...
	arm-none-eabi-gcc -x assembler-with-cpp -Ddebug -I"C:/djysdk/djyos_workspace/examples/qh_1/src/bsp/arch/cpu/include" -Wall -Wa,-adhlns="$@.lst" -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -mcpu=cortex-m3 -mthumb -g3 -gdwarf-2 -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
